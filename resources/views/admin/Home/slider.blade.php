                ...
                <form method="POST" action="/saveSlider" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="moreInfoLink" name="more_info_link" placeholder="Enter More Info Link">
                        </div>
                    </div>
            ...
            <table id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#sliderModal{{ $slider->id }}">Edit</button>
